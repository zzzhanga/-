    ...
    <div>
        ...
        <div class="scroll-wrapper">
            <cube-scroll>
                <div class="item">
                    <span>阅读时不自动锁屏</span>
                    <cube-switch v-model="lockScreen">
                    </cube-switch>
                </div>
                <div class="item">
                    <span>阅读时横屏</span>
                    <cube-switch v-model="landScape">
                    </cube-switch>
                </div>
                <div class="item">
                    <span>翻页方式</span>
                    <cube-select class="flipWay" v-model="flipWay" :options="options">
                    </cube-select>
                </div>
                <div class="item">
                    <span>阅读时隐藏热门讨论</span>
                    <cube-switch v-model="hideDiscuss"  >
                    </cube-switch>
                </div>
                <div class="item">
                    <span>使用音量键翻页</span>
                    <cube-switch v-model="volumeButton">
                    </cube-switch>
                </div>
                <div class="item">
                    <span>首行缩进</span>
                    <cube-switch v-model="attention">
                    </cube-switch>
                </div>
                <div class="hr"></div>
                <div class="item">
                    ...
                    <cube-switch v-model="retract">
                    </cube-switch>
                </div>
                <div class="item">
                    <span>不接受未关注人的私信</span>
                    <cube-switch v-model="noAcceptable">
                    </cube-switch>
                </div>
                <div class="hr"></div>
                <div class="item">
                    <span>接受推送通知</span>
                    <cube-switch v-model="pushService">
                    </cube-switch>
                </div>
                <div class="item">
                    <div class="item-flex">
                    ...
                    <cube-switch v-model="newAttention">
                    </cube-switch>
                </div>
                <div class="item">
                    <div class="item-flex">
                    ...
                    <cube-switch v-model="freeUpdates">
                    </cube-switch>
                </div>
                <div class="hr"></div>
                <p class="item">清理缓存</p>
